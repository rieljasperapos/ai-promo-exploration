  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an AI that provides insights about promotional discounts."
        },
        {
          role: "user",
    ...
    return response.choices[0].message.content || "Here are the list of promo items that you can avail today";
  } catch (error) {
