...
exports.NomicEmbeddings = void 0;
 ...
 */
class NomicEmbeddings extends embeddings_1.Embeddings {
    get lc_secrets() {
        return {
    ...
    constructor(fields) {
        ...
        const apiKey = fields?.apiKey ?? (0, env_1.getEnvironmentVariable)("NOMIC_API_KEY");
        if (!apiKey) {
            throw new Error("NOMIC_API_KEY is required.");
        }
        this.client = new atlas_1.AtlasUser({ apiKey });
...
exports.NomicEmbeddings = NomicEmbeddings;
