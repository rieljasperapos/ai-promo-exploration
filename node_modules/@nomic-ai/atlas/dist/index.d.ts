...
export declare class AtlasIndex extends BaseAtlasClass<{}> {
    ...
    project: AtlasDataset;
    constructor(id: Atlas.UUID, user?: AtlasUser | AtlasViewer, options?: IndexInitializationOptions);
     ...
     */
    nearest_neighbors(nn_options: Atlas.NNOptions): Promise<Table>;
    /**
     *
     ...
     * @returns
     */
    nearest_neighbors_by_vector({ k, queries, }: Omit<components['schemas']['EmbeddingNeighborRequest'], 'atlas_index_id'>): Promise<components['schemas']['EmbeddingNeighborResponse']>;
}
export {};
