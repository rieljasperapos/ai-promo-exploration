...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        AccessRole: 'OWNER' | 'ADMIN' | 'MEMBER' | 'VIEWER' | 'EXTERNAL' | 'GUEST' | 'NONE';
        /** AddBlobResponse */
        AddBlobResponse: {
            /**
             * Hashes
        ...
        EmbeddingModelInferenceUsage: {
             ...
             */
            model: components['schemas']['NomicTextEmbeddingModel'] | components['schemas']['NomicVisionEmbeddingModel'];
            /**
             * Tokens
        ...
        GeometryCollection: {
            ...
            /** Geometries */
            geometries: (components['schemas']['Point'] | components['schemas']['MultiPoint'] | components['schemas']['LineString'] | components['schemas']['MultiLineString'] | components['schemas']['Polygon'] | components['schemas']['MultiPolygon'])[];
        };
        /** GetBlobResponse */
        GetBlobResponse: {
            /**
         ...
         * @enum {unknown}
         */
        NomicTextEmbeddingModel: 'all-MiniLM-L6-v2' | 'nomic-embed-text-v1' | 'nomic-embed-text-v1.5' | 'nomic-embed-code';
        /**
         * NomicVisionEmbeddingModel
         * @description An enumeration.
         * @enum {unknown}
         */
        NomicVisionEmbeddingModel: 'nomic-embed-vision-v1' | 'nomic-embed-vision-v1.5';
         ...
         * @enum {unknown}
         */
        OrganizationPlan: 'atlas_demo' | 'atlas_enterprise' | 'atlas_research' | 'atlas_starter' | 'atlas_startup' | 'atlas_pro' | 'mock' | 'free_test_user' | 'pro' | 'enterprise' | 'free' | 'research';
...
export interface operations {
    ...
    fetch_organization_v1_organization__organization_id_or_slug__get: {
        ...
        responses: {
            ...
            200: {
                content: {
                    'application/json': components['schemas']['Organization'] | components['schemas']['PublicOrganizationResponse'];
                };
            };
    ...
    update_tag_request_v1_project_projection_tags_update_post: {
        requestBody: {
            content: {
                'application/json': components['schemas']['UpdateTagNameRequest'] | components['schemas']['UpdateTagDefinitionRequest'];
            };
        };
        responses: {
            /** @description Successful Response */
